...
static PyMethodDef PyViewCamera_methods[] = {
    ...
    { "fit", reinterpret_cast<PyCFunction>(PyViewCamera_fit), METH_NOARGS, "Get the framing fit multiplier" },
    { "setFit", reinterpret_cast<PyCFunction>(PyViewCamera_setFit), METH_VARARGS, "Set the framing fit multiplier" },

    { "cameraUp", reinterpret_cast<PyCFunction>(PyViewCamera_cameraUp), METH_NOARGS, "Get the camera up axis" },
    { "setCameraUp", reinterpret_cast<PyCFunction>(PyViewCamera_setCameraUp), METH_VARARGS, "Set the camera up axis" },
    { "axisYaw", reinterpret_cast<PyCFunction>(PyViewCamera_axisYaw), METH_NOARGS, "Get the camera yaw angle" },
    { "setAxisYaw", reinterpret_cast<PyCFunction>(PyViewCamera_setAxisYaw), METH_VARARGS, "Set the camera yaw angle" },
    { "axisPitch", reinterpret_cast<PyCFunction>(PyViewCamera_axisPitch), METH_NOARGS, "Get the camera pitch angle" },
    { "setAxisPitch", reinterpret_cast<PyCFunction>(PyViewCamera_setAxisPitch), METH_VARARGS,
      "Set the camera pitch angle" },
    { "axisRoll", reinterpret_cast<PyCFunction>(PyViewCamera_axisRoll), METH_NOARGS, "Get the camera roll angle" },
    ...
    { "reset", reinterpret_cast<PyCFunction>(PyViewCamera_reset), METH_NOARGS, "Reset the camera to default state" },
