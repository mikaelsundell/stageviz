...
addStyleEnums()
{
    static const EnumEntry colorRoles[] = { { "Accent", static_cast<long>(Style::ColorRole::Accent) },
                                            ...
                                            { "Graph", static_cast<long>(Style::ColorRole::Graph) },
                                            { "Grid", static_cast<long>(Style::ColorRole::Grid) },
                                            { "Guide", static_cast<long>(Style::ColorRole::Guide) },
                                            ...
                                            { "TextAlt", static_cast<long>(Style::ColorRole::TextAlt) },
                                            { "Warning", static_cast<long>(Style::ColorRole::Warning) } };

    static const EnumEntry iconRoles[] = { { "BranchClosed", static_cast<long>(Style::IconRole::BranchClosed) },
                                           ...
                                           { "DefaultPrim", static_cast<long>(Style::IconRole::DefaultPrim) },
                                           ...
                                           { "Over", static_cast<long>(Style::IconRole::Over) },
                                           { "Override", static_cast<long>(Style::IconRole::Override) },
                                           { "PartiallyChecked", static_cast<long>(Style::IconRole::PartiallyChecked) },
                                           { "Payload", static_cast<long>(Style::IconRole::Payload) },
                                           { "Pick", static_cast<long>(Style::IconRole::Pick) },
    ...
    static const EnumEntry uiScales[] = { { "Small", static_cast<long>(Style::UIScale::Small) },
                                          { "Medium", static_cast<long>(Style::UIScale::Medium) },
                                          { "Large", static_cast<long>(Style::UIScale::Large) } };

    static const EnumEntry uiStates[] = { { "Normal", static_cast<long>(Style::UIState::Normal) },
